...
for hyperparam in hyperparam_config[start:end]:
    ...
    config_object["parametersetting"] = {
            ...
            "maxepochs": 50, #150
            "numworkers": 8,
            "lr": hyperparam_config[0]['lr'], #10**float(hyperparam['lr']), #0.001, 0.00002
            "wtdecay": hyperparam_config[0]['wtdecay'], #10**float(hyperparam['wtdecay']), #0.0005, 0.00001
            "sm_reg_param": hyperparam_config[0]['sm_reg_param'], #10**float(hyperparam['sm_reg_param']), False
            "groundtruthdic": {'benign':0,'malignant':1},
            "classes": [0,1],
            "resize": [2944, 1920], #options=1600, mgm: [2944,1920], vindr:[2700, 990], None (for padding to max image size )
            "cam_size": (92, 60), #vindr: (85, 31), mgm:(92, 60)
            "dataaug": 'gmic', #options=small, big, wang, gmic, kim, shu
            "imagecleaning": 'own',
            "datasplit": 'casebasedtestset', #options: officialtestset, casebasedtestset
            ...
            "dataset": 'cbis-ddsm', #options = cbis-ddsm, mgm, vindr
            ...
            "MIL_csvfilepath": "/projects/dso_mammovit/project_kushal/data/cbis-ddsm_multiinstance_groundtruth.csv", #"/homes/spathak/multiview_mammogram/input_data/MG_training_files_studyUID_accessionNum_viewnames_final4_viewsextended.csv", #, #, #, #"/groups/dso/spathak/vindr/MG_training_files_vindr_multiinstance_groundtruth.csv", #, #,
            "preprocessed_imagepath": "/projects/dso_mammovit/project_kushal/data/multiinstance_data_16bit", #"/groups/dso/spathak", #"/projects/dso_mammovit/project_kushal/data/multiinstance_data_8bit", #, #"/groups/dso/spathak/vindr/processed_png_8bit", #, #, #"/local/work/spathak/mgm",
            "valloss_resumetrain": False,
            "papertoreproduce": False,
            "extra": 'dynamic_training' #options: dynamic_training
    }
    count+=1
    filename=''
    ...
    elif config_object["parametersetting"]['dataset'] == 'mgm':
        path_to_output="/homes/spathak/multiview_mammogram/models_results/mgm/ijcai23/"+filename+"/"
