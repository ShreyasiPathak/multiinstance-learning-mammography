...
for hyperparam in hyperparam_config[start:end]:
    ...
    config_object["parametersetting"] = {
            ...
            "classes": [0,1],
            "resize": [2944, 1920], #options=1600, zgt: [2944,1920], vindr:[2700, 990], None (for padding to max image size )
            ...
            "preprocessed_imagepath": "/projects/dso_mammovit/project_kushal/data/multiinstance_data_16bit", #"/groups/dso/spathak", #"/groups/dso/spathak/vindr/processed_png_16bit", #, #"/groups/dso/spathak/vindr/processed_png_16bit", #"/local/work/spathak/zgt", #options: "/projects/dso_mammovit/project_kushal/data/multiinstance_data_8bit",
