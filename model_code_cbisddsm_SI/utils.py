...
class MyPaddingLongerSide:
    def __init__(self, resize):
        self.max_height=resize
        self.max_width=resize
...
class BreastCancerDataset_generator(Dataset):
    ...
    def __init__(self, df, modality, datascaling, resize, flipimage, inchans, transform=None):
        """
        Args:
...
def data_augmentation_train_shu(mean,std_dev,resize,datascaling):
    ...
    if resize:
        preprocess_train_list.append(transforms.Resize((resize,resize)))
...
def data_augmentation_test(mean,std_dev,resize,datascaling):
    ...
    if resize:
        preprocess_test_list.append(transforms.Resize((resize,resize)))
