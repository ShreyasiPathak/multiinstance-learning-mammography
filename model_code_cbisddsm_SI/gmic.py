...
def _gmic(gmic_parameters):
    ...
    if gmic_parameters['pretrained']:
        ...
        #print(len(list(resnet_pretrained_dict.keys())))
        #print("resnet:",resnet_pretrained_dict.keys())

        #print("resnet pretrained weights:",resnet_pretrained_dict['conv1.weight'])
        
        gmic_model_dict = gmic_model.state_dict()
        global_network_dict = {k:v for (k,v) in gmic_model_dict.items() if 'ds_net' in k}
        #print(len(list(global_network_dict.keys())))
        #print("global network:",global_network_dict.keys())
        ...
        #print(len(list(global_network_pretrained_dict.keys())))
        #print("global network pretrained:",global_network_pretrained_dict.keys())
        ...
        #print(len(list(local_network_dict.keys())))
        #print("global network:",local_network_dict.keys())
        ...
        #print(len(list(local_network_pretrained_dict.keys())))
        #print("global network pretrained:",local_network_pretrained_dict.keys())
        ...
        #print("gmic global network weights:",gmic_model.state_dict()['ds_net.conv1.weight'])
        #print("gmic local network weights:",gmic_model.state_dict()['dn_resnet.conv1.weight'])
